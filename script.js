...
*/
const teams = {
  team1: { name: "Mumbai Indians", budget: 400, players: [], bids: [] },
  team2: { name: "Delhi Capitals", budget: 200, players: [], bids: [] },
  team3: {
    name: "Royal Challenger Bengaluru",
    budget: 500,
    players: [],
    bids: [],
  },
